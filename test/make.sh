#!/bin/sh
COMPILE="g++ -O2 -ggdb -I . -Wall -Wextra -DTF_NETWORK_DEBUG_LOG=1 -I ../../tftools/src ../../tftools/src/TFTools/Micros.cpp ../src/TFNetwork.cpp"
$COMPILE ../src/TFGenericTCPClient.cpp ../src/TFModbusTCPClient.cpp ../src/TFModbusTCPCommon.cpp test_client.cpp -o test_client
$COMPILE ../src/TFGenericTCPClient.cpp ../src/TFModbusTCPClient.cpp ../src/TFModbusTCPCommon.cpp test_client_simple.cpp -o test_client_simple
...
$COMPILE ../src/TFGenericTCPClient.cpp ../src/TFModbusTCPClient.cpp ../src/TFModbusTCPCommon.cpp ../src/TFGenericTCPClientPool.cpp ../src/TFModbusTCPClientPool.cpp test_pool_simple.cpp -o test_pool_simple
